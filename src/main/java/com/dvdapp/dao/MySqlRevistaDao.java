...
public class MySqlRevistaDao extends AbstractMySqlMaterialDao<Revista> implements RevistaDao {
    ...
    public Revista save(Revista revista) throws SQLException {
        ...
        final String sqlRevista = "INSERT INTO revista (codigo_id, periodicidad, fecha_publicacion) VALUES (?, ?, ?)";
        ...
        try (Connection connection = ConnectionManager.getConnection()) {
            ...
            try {
                ...
                try (PreparedStatement materialStatement = connection.prepareStatement(sqlMaterial);
                    ...
                    materialStatement.setInt(3, revista.getUnidadesDisponibles());
    ...
    public void update(Revista revista) throws SQLException {
        ...
        final String sqlRevista = "UPDATE revista SET periodicidad = ?, fecha_publicacion = ? WHERE codigo_id = ?";
        ...
        try (Connection connection = ConnectionManager.getConnection()) {
            ...
            try {
                ...
                try (PreparedStatement materialStatement = connection.prepareStatement(sqlMaterial)) {
                    ...
                    materialStatement.setInt(2, revista.getUnidadesDisponibles());
                ...
                try (PreparedStatement revistaStatement = connection.prepareStatement(sqlRevista)) {
                    revistaStatement.setString(1, revista.getPeriodicidad());
                    revistaStatement.setDate(2, parseSqlDate(revista.getFechaPublicacion()));
                    revistaStatement.setString(3, code);
    ...
    public Revista findByCode(String code) throws SQLException {
        final String sql = "SELECT m.codigo, m.titulo, m.unidades_disponibles, r.periodicidad, r.fecha_publicacion "
    ...
    public List<Revista> search(String text) throws SQLException {
        ...
        final String sql = "SELECT m.codigo, m.titulo, m.unidades_disponibles, r.periodicidad, r.fecha_publicacion "
                ...
                + "WHERE LOWER(m.codigo) LIKE ? OR LOWER(m.titulo) LIKE ? OR LOWER(r.periodicidad) LIKE ? "
