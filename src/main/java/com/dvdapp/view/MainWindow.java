...
public class MainWindow extends JFrame {
    ...
    private void cargarParaEditar(String codigo) {
        try {
            ...
            unidadesField.setText(String.valueOf(m.getUnidadesDisponibles()));
    ...
    private String[] columnsForType(String tipo) {
        return switch (tipo) {
            case "DVD" -> new String[]{"Codigo", "Titulo", "Unidades", "Duracion", "Genero", "Director"};
            case "Libro" -> new String[]{"Codigo", "Titulo", "Unidades", "Autor", "ISBN"};
            case "Revista" -> new String[]{"Codigo", "Titulo", "Unidades", "Periodicidad", "Fecha"};
            case "CD" -> new String[]{"Codigo", "Titulo", "Unidades", "Artista", "Canciones"};
